...
<div>
	<form:form id="frmDetails" modelAttribute="record" method="POST">
		...
		<table class="tblForm">
			<tr>
				<td>Data Emitere</td>
				<td><c:if test="${screenStatus == 'view'}">
						<input type="text"
							value="<fmt:formatDate pattern = "dd.MM.yyyy" value = "${record.dtEmitere}" />"
							disabled>
					</c:if> <c:if test="${screenStatus != 'view'}">
			...
			<tr>
				...
				<td><c:if test="${screenStatus == 'view'}">
						<input type="text"
							value="<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${record.suma}" />"
							disabled>
					</c:if> <c:if test="${screenStatus != 'view'}">
			...
			<tr>
				...
				<td><c:if test="${screenStatus == 'view'}">
						<input type="text"
							value="<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${record.tva}" />"
							disabled>
					</c:if> <c:if test="${screenStatus != 'view'}">
						<form:input path="tva" />
					</c:if></td>
			...
			<tr>
				...
				<td><c:if test="${screenStatus == 'view'}">
						<input type="text"
							value="<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${record.total}" />"
							disabled>
					</c:if> <c:if test="${screenStatus != 'view'}">
			...
			<tr>
				...
				<td><c:if test="${screenStatus == 'view'}">
						<input type="text"
							value="<fmt:formatDate pattern = "dd.MM.yyyy" value = "${record.dtScadenta}" />"
							disabled>
					</c:if> <c:if test="${screenStatus != 'view'}">
